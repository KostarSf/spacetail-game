import { Actor, ActorArgs, Color, ExcaliburGraphicsContext, Sprite, vec } from "excalibur";
...
export class StyledActor extends Actor {
    ...
    protected onPreDraw(ctx: ExcaliburGraphicsContext, _delta: number) {
        ...
        const shadowOrigin = origin.add(vec(0, shadowOffset)).rotate(-this.rotation, origin);
