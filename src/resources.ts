import { ImageSource, Loader, SpriteSheet, Animation, range, AnimationStrategy } from "excalibur";
...
function getAsteroidImage(type: keyof typeof Resources.Asteroid, index?: number): ImageSource {
...
class Animations {
    static get Bullet() {
        ...
        const blinkAnimation = Animation.fromSpriteSheet(blinkSheet, range(0, 1), 250);
